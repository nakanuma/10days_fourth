...
// 障害物や敵に弾が当たったときに発生
// =========================================================
class TemplateParticle : public Cygnus::BaseParticleEffect<TemplateParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	TemplateParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	TemplateParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
	...
	void UpdateParticle(TemplateParticleData& p, float dt) override;
